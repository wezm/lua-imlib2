...
do
  ...
  function test_set()
    ...
    assert_error("no enough arguments should cause an error", function() a_filter:set(1) end)
  ...
  function test_set_alpha()
    ...
    assert_error("no enough arguments should cause an error", function() a_filter:set_alpha(1) end)
  ...
  function test_set_red()
    ...
    assert_error("no enough arguments should cause an error", function() a_filter:set_red(1) end)
  ...
  function test_set_green()
    ...
    assert_error("no enough arguments should cause an error", function() a_filter:set_green(1) end)
  ...
  function test_set_blue()
    ...
    assert_error("no enough arguments should cause an error", function() a_filter:set_blue(1) end)
  ...
  function test_constants()
    ...
    assert_error("no enough arguments should cause an error", function() a_filter:constants(1) end)
  ...
  function test_divisors()
    ...
    assert_error("no enough arguments should cause an error", function() a_filter:divisors(1) end)
